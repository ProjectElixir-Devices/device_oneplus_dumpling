...
git clone --depth=1 https://github.com/ProjectElixir-Devices/device_oneplus_dumpling -b A13 device/oneplus/dumpling
echo ""
...
git clone --depth=1 https://github.com/ProjectElixir-Devices/kernel_oneplus_msm8998 -b A13 kernel/oneplus/msm8998
echo ""